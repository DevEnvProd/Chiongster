...
export function MainMenu() {
  ...
  const menuItems: MenuItem[] = [
    ...
    { icon: Coins, label: "My Drink Dollars", slug: "my-drink-dollars/how-it-works" },
    { icon: Diamond, label: "Insider Benefits", slug: "insider-benefit/how-it-works" },
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="left" className="w-full sm:w-[400px] p-0 bg-[#121212] border-zinc-800 flex flex-col">
        {/* Profile Section */}
        <div className="relative h-[120px] bg-[#1E1E1E] p-4 flex-shrink-0">
